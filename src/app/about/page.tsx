        ...
        <div className={CONTAINER}>
          ...
          <Reveal className="mt-16">
            <p className="max-w-2xl text-sm leading-relaxed text-ink/60">
              ...
              different styles. I enjoy the process of getting my hands
              dirty and creating designs inspired by my surroundings and the
              diverse cultures and art forms I encounter. Whenever possible,
              I try to incorporate social messages into my work to make a
              positive impact. Overall, I find that hand lettering and type
              design allow me to express myself creatively and communicate
